...
We would also like to identify a maximal threshold, perhaps as a ratio between perturbed and actual facts, in discovering effectiveness of attacks against KGE models. This threshold will serve as a benchmark for assessing the magnitude of perturbations required to induce significant changes in the models' behavior, providing valuable insights into the vulnerability of KGE models to adversarial attacks.
